    ...
    public partial class Sil : Form
    {
        ...
        private void Sil_Load(object sender, EventArgs e)
        {
            if (table == 1)
                ...
                //usertable = DB.select("urun where firmakodu = '" + fkod + "'", "urunismi,urunkodu,nakifiyat,kredifiyat,indirimorani");
            else
                ...
                //usertable = DB.select("renk where firmakodu = '" + fkod + "' and urunkodu = '" + ukod + "'", "renkismi,renkkodu,urunkodu,firmakodu");
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (secilencell > 1)
            {
                if (table == 1)
                {
                    ...
                    DB.remove("renk where firmakodu = '" + fkod + "'");
                    DB.remove("urun where firmakodu = '" + fkod + "'");
                    DB.remove("firma where firmakodu = '" + fkod + "'");
                }
                else if (table == 2)
                {
                    uisim = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
                    ukod = dataGridView1.SelectedRows[0].Cells[1].Value.ToString();
                    DB.remove("renk where urunkodu = '" + ukod + "' and firmakodu = '" + fkod + "' and kategorikodu = '" + kkod + "' and turkodu = '" + tkod + "'");
                    DB.remove("urun where firmakodu = '" + fkod + "' and urunkodu = '" + ukod + "' and kategorikodu = '" + kkod + "' and turkodu = '" + tkod + "'");
                }
                else
                {
                    ...
                    DB.remove("renk where firmakodu = '" + fkod + "' and urunkodu = '" + ukod + "' and renkkodu = '" + rkod + "' and kategorikodu = '" + kkod + "' and turkodu = '" + tkod +"'");
                }
